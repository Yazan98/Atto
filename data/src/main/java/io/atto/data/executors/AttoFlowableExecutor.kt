...
import io.atto.data.AttoFlowableRequestExecutor
...
class AttoFlowableExecutor<T> : AttoFlowableRequestExecutor<T> {
    ...
    override fun subscribeRequest(request: Flowable<T>): Disposable {
